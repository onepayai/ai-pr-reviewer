...
const ignoreKeyword = '@codegenius: ignore'
...
`
  ...
  if (options.disableReleaseNotes === false) {
    ...
    if (releaseNotesResponse === '') {
      ...
      let message = '### Summary by CodeGenius\n\n'
...
<details>
<summary>Uplevel your code reviews with CodeGenius Pro</summary>

### CodeGenius Pro

If you like this project, please support us by purchasing the [Pro version](https://CodeGenius.ai). The Pro version has advanced context, superior noise reduction and several proprietary improvements compared to the open source version. Moreover, CodeGenius Pro is free for open source projects.
...
### Chat with <img src="https://avatars.githubusercontent.com/in/347564?s=41&u=fad245b8b4c7254fe63dd4dcd4d662ace122757e&v=4" alt="Image description" width="20" height="20">  CodeGenius Bot (\`@codegenius\`)
- Reply on review comments left by this bot to ask follow-up questions. A review comment is a comment on a diff or a file.
- Invite the bot into a review comment chain by tagging \`@codegenius\` in a reply.
...
- Add \`@codegenius: ignore\` anywhere in the PR description to pause further reviews from the bot.
